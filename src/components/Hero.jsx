...
const Hero = () => {
  ...
  return (
    <section className="hero max-sm:justify-between max-sm:h-screen relative container m-auto max-sm:flex max-sm:flex-col max-sm:gap-1">
      ...
      <div>
        <img
          ...
          alt=" "
          id="heroBg"
          className="filter bgSlide brightness-50 sm:brightness-100  w-full"
        />
