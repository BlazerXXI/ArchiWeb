...
const Hero = () => {
  ...
  return (
    <section className="hero relative container m-auto max-sm:flex max-sm:flex-col max-sm:gap-1">
      <div className="lg:w-[691px]   lg:h-[550px] sm:w-[450px]   sm:mt-[-150px]  lg:mt-[-275px]   sm:bg-gradient-to-t sm:from-[#F4F6F5E5] sm:to-[#FFFFFFE5] sm:absolute sm:top-1/2 top-0  left-0  ml-0 lg:ml-[-100px] lg:pl-[100px] py-4 pl-4 sm:py-[60px] lg:py-[138px] sm:pr-4  z-20 max-sm:min-h-[424px] max-sm:mb-1">
        <h1
          id="titleHero"
      ...
      <div className="">
        <img
          ...
          width="1150px"
          id="heroBg"
          className="filter bgSlide w-full brightness-50 sm:brightness-100 sm:min-h-[739px] min-h-[265px] object-cover"
        />
